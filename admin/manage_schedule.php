                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div style="background-color: white; padding: 20px; display: flex; justify-content: space-between; align-items: center;">
                            <a href="input_schedule.php" class="btn btn-success">
            ...
            <table class="table table-hover align-middle">
                ...
                <tbody style="border-top: 0;">
                    ...
                    if (isset($_GET['keyword'])) {
                        ...
                        $query = "SELECT date, time, description, event FROM schedule WHERE date LIKE '%$keyword%' OR time LIKE '%$keyword%' OR description LIKE '%$keyword%' OR event LIKE '%$keyword%'";
                    } else {
                        $query = "SELECT date, time, description, event FROM schedule";
                    }
                    ...
                    ?>
                        <tr style="border-bottom: 1px solid #f4f4f4; background-color: white;">
                            ...
                            <td class="py-3">
                                <a href="edit_schedule.php?date=<?php echo urlencode($data['date']); ?>" 
                                   style="color: #3c8dbc; text-decoration: none; font-weight: 500; margin-right: 15px; font-size: 14px;">
                                   Edit
                                </a>
                                <a href="hapus_schedule.php?hapus_schedule=<?php echo urlencode($data['date']); ?>" 
