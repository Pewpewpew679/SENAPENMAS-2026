            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Edit Komentar Mahasiswa</h1>
...
$NPM = $_GET["ubahkomentarmahasiswa"];
$JUDUL = $_GET["judul"];

$edit = mysqli_query($conn, "SELECT * FROM komentar_mahasiswa WHERE mhs_NPM = '$NPM' AND berita_JUDUL = '$JUDUL'");
...
if(isset($_POST['Ubah'])) 
{
    $mhs_NPM_baru = $_POST['mhs_NPM'];
    $berita_JUDUL_baru = $_POST['berita_JUDUL'];
    $komentar_ISI = $_POST['komentar_ISI'];
    $komentar_TGL = $_POST['komentar_TGL'];
    $komentar_WAKTU = $_POST['komentar_WAKTU'];
    
    mysqli_query($conn, "UPDATE komentar_mahasiswa SET mhs_NPM = '$mhs_NPM_baru', berita_JUDUL = '$berita_JUDUL_baru', komentar_ISI = '$komentar_ISI', komentar_TGL = '$komentar_TGL', komentar_WAKTU = '$komentar_WAKTU'
        WHERE mhs_NPM = '$NPM' AND berita_JUDUL = '$JUDUL'");
...
?>
  ...
  <div class="row mb-3 mt-5">
    ...
    <div class="col-sm-10">
      <select class="form-control" id="mhs_NPM" name="mhs_NPM">
        ...
        { 
            if($row["mhs_NPM"] == $row_edit['mhs_NPM']) { continue; }
        ?>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <select class="form-control" id="berita_JUDUL" name="berita_JUDUL">
        <option value="<?php echo $row_edit['berita_JUDUL']?>">
          <?php echo $row_edit['berita_JUDUL']?>
        </option>
        
        <?php while($row_berita = mysqli_fetch_array($databerita))
        { 
             if($row_berita["berita_JUDUL"] == $row_edit['berita_JUDUL']) { continue; }
        ?>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <textarea class="form-control" id="komentar_ISI" name="komentar_ISI" rows="5" placeholder="Tulis komentar..."><?php echo $row_edit['komentar_ISI']; ?></textarea>
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input type="date" class="form-control" id="komentar_TGL" name="komentar_TGL" value="<?php echo $row_edit['komentar_TGL']?>">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input type="time" class="form-control" id="komentar_WAKTU" name="komentar_WAKTU" value="<?php echo $row_edit['komentar_WAKTU']?>">
    </div>
  </div>
   ...
   <div class="col-1"></div>
        ...
        <div class="row">
            ...
            <div class="col-10">
                ...
                </div></div><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
