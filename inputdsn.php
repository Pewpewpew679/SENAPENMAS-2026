<!DOCTYPE html>
<html>
<!--pengaman halaman, memastikan hanya user yg udh login yg bisa mengakses halaman Input dosen.-->
    <?php
    ob_start();
    session_start();
...
/* untuk menyimpan data yg diinsert ke table dosen */
...
/* untuk cari data NIDN/nama dosen*/
...
<div class="row">
    ...
    <div class="col-10">
        ...
        <!--mencari data nidn dari tabel dosen-->
        <form method="POST">
        <div class="form-group row mt-5 mb-3">
            <label for="search" class="col-sm-2">Cari NIDN atau Nama Dosen</label> 
            <div class="col-sm-6">
        ...
        <!--menampilkan table dosen dari data yg udah diinsert-->
